...
func init() {
	proto.RegisterType((*HelloMessage)(nil), "fd8_judge_grpc_test.HelloMessage")
}
...
var fileDescriptor_c161fcfdc0c3ff1e = []byte{
	...
	,
}
...
func (c *testServiceClient) SayHello(ctx context.Context, in *HelloMessage, opts ...grpc.CallOption) (*HelloMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/fd8_judge_grpc_test.TestService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TestService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fd8_judge_grpc_test.TestService/SayHello",
	}
...
var _TestService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fd8_judge_grpc_test.TestService",
